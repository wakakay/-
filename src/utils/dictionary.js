...
export const ROUTERS = {
    ...
    'pages/training-camp-module/registration': {screenName: '训练营-报名', sence: 'teamLearnShare'},
    'pages/training-camp-module/registration-info': {screenName: '训练营-报名信息', sence: 'teamLearnShare'},
    'pages/training-camp-module/coursr-list': {screenName: '训练营-课程列表', sence: 'teamLearnShare'},
    'pages/training-camp-module/training-detail': {screenName: '训练营-课程列表', sence: 'teamLearnShare'},
    ...
    'pages/activity-module/new-appraisal-cover': {screenName: '新版测评封面', sence: 'preTestShare', isVisitor: true},
